...
function Field({ label, type = "text", value, onChange, placeholder, icon: Icon, error, rightSlot, autoComplete }: FieldProps) {
  return (
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      if (loginWithGoogle) {
        ...
        toast({ title: "Welcome!", description: "Signed up successfully with Google." });
        setLocation("/");
      } else {
      ...
      >
        ...
        <div className="bg-white/75 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/60 overflow-hidden"
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            {/* ── Google Signup Button (Dark Blue Styled) ── */}
            <div className="mb-5">
              <motion.button
                type="button"
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs text-gray-400 font-bold uppercase tracking-widest bg-transparent px-1">Or register with email</span>
