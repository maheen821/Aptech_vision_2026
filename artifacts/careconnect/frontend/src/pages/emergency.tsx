...
const ALL_HOSPITALS: Record<string, any[]> = {
  default: [
    { id: 1, name: "Aga Khan University Hospital", area: "Stadium Road, Karachi", address: "Stadium Rd, Karachi, Pakistan", distance: "0.6 km", open: true, phone: "+92 21 3493 0051", rating: 4.9, reviews: 5200, services: ["ICU", "Trauma", "Cardiac"], image: HOSP_IMGS[0] },
    { id: 2, name: "Liaquat National Hospital", area: "Gulshan, Karachi", address: "Liaquat National Hospital Rd, Karachi", distance: "1.1 km", open: true, phone: "+92 21 3412 1011", rating: 4.7, reviews: 3100, services: ["ER", "Neuro", "Orthopedic"], image: HOSP_IMGS[1] },
    { id: 3, name: "Ziauddin Hospital", area: "Clifton, Karachi", address: "4/B Shahra-e-Ghalib, Clifton, Karachi", distance: "1.8 km", open: true, phone: "+92 21 111 000 260", rating: 4.6, reviews: 2700, services: ["Cardiac", "ICU", "ER"], image: HOSP_IMGS[2] },
    { id: 4, name: "Jinnah Postgraduate Medical Centre", area: "Rafiqui Shaheed Rd", address: "Rafiqui Shaheed Rd, Karachi", distance: "2.5 km", open: true, phone: "+92 21 3272 0160", rating: 4.5, reviews: 4100, services: ["ER", "Trauma", "Burn Unit"], image: HOSP_IMGS[3] },
    { id: 5, name: "South City Hospital", area: "DHA, Karachi", address: "Block 7, Clifton, Karachi", distance: "3.2 km", open: true, phone: "+92 21 3589 8901", rating: 4.4, reviews: 1100, services: ["ER", "Pediatric", "ICU"], image: HOSP_IMGS[4] },
    { id: 6, name: "Civil Hospital Karachi", area: "Sarfraz Raffiqui Road", address: "Sarfraz Raffiqui Rd, Karachi", distance: "4.0 km", open: true, phone: "+92 21 3272 0051", rating: 4.3, reviews: 3800, services: ["ER", "Surgery", "ICU"], image: HOSP_IMGS[5] },
  ],
  karachi: [
    { id: 1, name: "Aga Khan University Hospital", area: "Stadium Road", address: "Stadium Rd, Karachi, Pakistan", distance: "0.6 km", open: true, phone: "+92 21 3493 0051", rating: 4.9, reviews: 5200, services: ["ICU", "Trauma", "Cardiac"], image: HOSP_IMGS[0] },
    { id: 2, name: "Liaquat National Hospital", area: "Gulshan", address: "Liaquat National Hospital Rd, Karachi", distance: "1.1 km", open: true, phone: "+92 21 3412 1011", rating: 4.7, reviews: 3100, services: ["ER", "Neuro", "Orthopedic"], image: HOSP_IMGS[1] },
    { id: 3, name: "Ziauddin Hospital", area: "Clifton", address: "4/B Shahra-e-Ghalib, Clifton, Karachi", distance: "1.8 km", open: true, phone: "+92 21 111 000 260", rating: 4.6, reviews: 2700, services: ["Cardiac", "ICU", "ER"], image: HOSP_IMGS[2] },
    { id: 4, name: "Jinnah Postgraduate Medical Centre", area: "Rafiqui Shaheed Rd", address: "Rafiqui Shaheed Rd, Karachi", distance: "2.5 km", open: true, phone: "+92 21 3272 0160", rating: 4.5, reviews: 4100, services: ["ER", "Trauma", "Burn Unit"], image: HOSP_IMGS[3] },
    { id: 5, name: "South City Hospital", area: "DHA", address: "Block 7, Clifton, Karachi", distance: "3.2 km", open: true, phone: "+92 21 3589 8901", rating: 4.4, reviews: 1100, services: ["ER", "Pediatric", "ICU"], image: HOSP_IMGS[4] },
    { id: 6, name: "Civil Hospital Karachi", area: "Sarfraz Raffiqui Rd", address: "Sarfraz Raffiqui Rd, Karachi", distance: "4.0 km", open: true, phone: "+92 21 3272 0051", rating: 4.3, reviews: 3800, services: ["ER", "Surgery", "ICU"], image: HOSP_IMGS[5] },
  ],
  lahore: [
    { id: 1, name: "Shaukat Khanum Cancer Hospital", area: "Johar Town", address: "7-A, Block R-3, Johar Town, Lahore", distance: "0.5 km", open: true, phone: "+92 42 3590 5000", rating: 4.9, reviews: 6100, services: ["Oncology", "ICU", "ER"], image: HOSP_IMGS[0] },
    { id: 2, name: "Services Hospital Lahore", area: "Jail Road", address: "Jail Rd, Lahore", distance: "1.2 km", open: true, phone: "+92 42 3576 4471", rating: 4.6, reviews: 3400, services: ["ER", "Trauma", "Neuro"], image: HOSP_IMGS[1] },
    { id: 3, name: "Ittefaq Hospital", area: "Model Town", address: "Model Town, Lahore", distance: "2.0 km", open: true, phone: "+92 42 3516 0200", rating: 4.7, reviews: 2900, services: ["Cardiac", "ICU", "ER"], image: HOSP_IMGS[2] },
    { id: 4, name: "Doctors Hospital", area: "Canal Road", address: "152-G/1, Canal Bank, Lahore", distance: "2.8 km", open: true, phone: "+92 42 3591 0000", rating: 4.8, reviews: 4700, services: ["ER", "Surgery", "Pediatric"], image: HOSP_IMGS[3] },
    { id: 5, name: "Mayo Hospital", area: "Nila Gumbad", address: "Nila Gumbad, Lahore", distance: "3.5 km", open: true, phone: "+92 42 3732 4880", rating: 4.4, reviews: 5200, services: ["ER", "ICU", "Burn Unit"], image: HOSP_IMGS[4] },
    { id: 6, name: "Hameed Latif Hospital", area: "Ferozepur Road", address: "14 Abu Bakar Block, Ferozepur Rd, Lahore", distance: "4.2 km", open: false, phone: "+92 42 3571 0000", rating: 4.5, reviews: 1800, services: ["Cardiac", "ER", "ICU"], image: HOSP_IMGS[5] },
  ],
  islamabad: [
    { id: 1, name: "Pakistan Institute of Medical Sciences", area: "G-8/3", address: "G-8/3, Islamabad", distance: "0.8 km", open: true, phone: "+92 51 9261 170", rating: 4.7, reviews: 4800, services: ["ICU", "ER", "Trauma"], image: HOSP_IMGS[0] },
    { id: 2, name: "Shifa International Hospital", area: "H-8/4", address: "Pitras Bokhari Rd, H-8/4, Islamabad", distance: "1.4 km", open: true, phone: "+92 51 8461 000", rating: 4.8, reviews: 3600, services: ["Cardiac", "ER", "Neuro"], image: HOSP_IMGS[1] },
    { id: 3, name: "Poly Clinic Hospital", area: "G-6/2", address: "Mauve Area, G-6/2, Islamabad", distance: "2.1 km", open: true, phone: "+92 51 9217 530", rating: 4.5, reviews: 2100, services: ["ER", "Surgery", "ICU"], image: HOSP_IMGS[2] },
    { id: 4, name: "Federal Government Polyclinic", area: "G-6", address: "G-6, Islamabad", distance: "2.9 km", open: true, phone: "+92 51 9217 701", rating: 4.3, reviews: 2900, services: ["ER", "Urgent Care", "ICU"], image: HOSP_IMGS[3] },
    { id: 5, name: "Ali Medical Centre", area: "I-8 Markaz", address: "I-8 Markaz, Islamabad", distance: "3.5 km", open: true, phone: "+92 51 4934 333", rating: 4.6, reviews: 1700, services: ["ER", "Cardiac", "Pediatric"], image: HOSP_IMGS[4] },
    { id: 6, name: "Maroof International Hospital", area: "F-10 Markaz", address: "F-10 Markaz, Islamabad", distance: "4.8 km", open: false, phone: "+92 51 2291 000", rating: 4.4, reviews: 1200, services: ["Surgery", "ICU", "ER"], image: HOSP_IMGS[5] },
  ],
  gulshan: [
    { id: 1, name: "Liaquat National Hospital", area: "Gulshan-e-Iqbal", address: "Liaquat National Hospital Rd, Gulshan, Karachi", distance: "0.3 km", open: true, phone: "+92 21 3412 1011", rating: 4.8, reviews: 3100, services: ["ER", "Trauma", "ICU"], image: HOSP_IMGS[0] },
    { id: 2, name: "Gulshan Medical Center", area: "Gulshan Block 6", address: "Block 6 Gulshan-e-Iqbal, Karachi", distance: "0.7 km", open: true, phone: "+92 21 3498 0012", rating: 4.5, reviews: 860, services: ["ER", "Urgent Care"], image: HOSP_IMGS[1] },
    { id: 3, name: "Al-Tibri Medical College Hospital", area: "Gulshan Block 16", address: "Block 16, Gulshan-e-Iqbal, Karachi", distance: "1.2 km", open: true, phone: "+92 21 3498 5000", rating: 4.4, reviews: 720, services: ["ER", "Pediatric", "ICU"], image: HOSP_IMGS[2] },
    { id: 4, name: "Nazimabad General Hospital", area: "Gulshan Adjacent", address: "Nazimabad No. 3, Karachi", distance: "2.0 km", open: true, phone: "+92 21 3661 4000", rating: 4.2, reviews: 540, services: ["ER", "Surgery"], image: HOSP_IMGS[3] },
    { id: 5, name: "Ziauddin Hospital North", area: "North Nazimabad", address: "Block N, North Nazimabad, Karachi", distance: "2.8 km", open: true, phone: "+92 21 111 000 260", rating: 4.6, reviews: 1900, services: ["Cardiac", "ER", "ICU"], image: HOSP_IMGS[4] },
    { id: 6, name: "Safari Park Hospital", area: "Gulshan-e-Hadeed", address: "Gulshan-e-Hadeed, Karachi", distance: "4.1 km", open: false, phone: "+92 21 3471 2000", rating: 4.1, reviews: 380, services: ["ER", "Urgent Care"], image: HOSP_IMGS[5] },
  ],
  dha: [
    { id: 1, name: "South City Hospital", area: "DHA Phase 2", address: "Block 7 Clifton DHA, Karachi", distance: "0.4 km", open: true, phone: "+92 21 3589 8901", rating: 4.6, reviews: 1100, services: ["ER", "Pediatric", "ICU"], image: HOSP_IMGS[0] },
    { id: 2, name: "Shifa International (DHA)", area: "DHA Phase 6", address: "Plot 62 DHA Phase 6, Karachi", distance: "1.2 km", open: true, phone: "+92 21 3599 1234", rating: 4.7, reviews: 1900, services: ["Cardiac", "Trauma", "ER"], image: HOSP_IMGS[1] },
    { id: 3, name: "Aga Khan DHA Clinic", area: "DHA Phase 5", address: "Phase 5, DHA, Karachi", distance: "1.9 km", open: true, phone: "+92 21 3493 9090", rating: 4.8, reviews: 2100, services: ["ER", "ICU", "Cardiac"], image: HOSP_IMGS[2] },
    { id: 4, name: "Al-Ain Hospital DHA", area: "DHA Phase 4", address: "Phase 4, DHA, Karachi", distance: "2.5 km", open: true, phone: "+92 21 3588 0000", rating: 4.4, reviews: 870, services: ["ER", "Orthopedic"], image: HOSP_IMGS[3] },
    { id: 5, name: "KPT Hospital", area: "Kehkashan", address: "Kehkashan, Clifton, Karachi", distance: "3.3 km", open: true, phone: "+92 21 3561 1111", rating: 4.3, reviews: 650, services: ["ER", "Surgery", "ICU"], image: HOSP_IMGS[4] },
    { id: 6, name: "Navy Hospital PNS Shifa", area: "DHA Clifton", address: "PNS Shifa, Clifton, Karachi", distance: "4.0 km", open: true, phone: "+92 21 3560 0300", rating: 4.5, reviews: 980, services: ["Trauma", "ER", "ICU"], image: HOSP_IMGS[5] },
  ],
  "north nazimabad": [
    { id: 1, name: "Abbasi Shaheed Hospital", area: "North Nazimabad", address: "Block B North Nazimabad, Karachi", distance: "0.5 km", open: true, phone: "+92 21 3661 2345", rating: 4.4, reviews: 890, services: ["ER", "ICU"], image: HOSP_IMGS[0] },
    { id: 2, name: "Hussaini Hospital", area: "Abbas Town", address: "Abbas Town, Karachi", distance: "0.9 km", open: true, phone: "+92 21 3663 4567", rating: 4.3, reviews: 740, services: ["ER", "Urgent Care"], image: HOSP_IMGS[1] },
    { id: 3, name: "Ziauddin Hospital North", area: "North Nazimabad Block N", address: "Block N, North Nazimabad, Karachi", distance: "1.5 km", open: true, phone: "+92 21 111 000 260", rating: 4.6, reviews: 1900, services: ["Cardiac", "ER", "ICU"], image: HOSP_IMGS[2] },
    { id: 4, name: "Fatimid Foundation", area: "North Karachi", address: "Sector 5-C/3, North Karachi", distance: "2.1 km", open: true, phone: "+92 21 3699 1234", rating: 4.5, reviews: 1200, services: ["ER", "Blood Bank", "ICU"], image: HOSP_IMGS[3] },
    { id: 5, name: "Al Khidmat Hospital", area: "Nazimabad", address: "Nazimabad No. 3, Karachi", distance: "2.7 km", open: true, phone: "+92 21 3661 0000", rating: 4.2, reviews: 620, services: ["ER", "Surgery"], image: HOSP_IMGS[4] },
    { id: 6, name: "National Medical Centre", area: "Liaquatabad", address: "Liaquatabad, Karachi", distance: "3.4 km", open: false, phone: "+92 21 3662 5000", rating: 4.1, reviews: 410, services: ["ER", "Urgent Care"], image: HOSP_IMGS[5] },
  ],
  peshawar: [
    { id: 1, name: "Lady Reading Hospital", area: "Peshawar City", address: "Peshawar City, KPK", distance: "0.7 km", open: true, phone: "+92 91 921 1240", rating: 4.6, reviews: 4200, services: ["ER", "Trauma", "ICU"], image: HOSP_IMGS[0] },
    { id: 2, name: "Hayatabad Medical Complex", area: "Hayatabad", address: "Phase 5, Hayatabad, Peshawar", distance: "1.3 km", open: true, phone: "+92 91 922 9401", rating: 4.7, reviews: 3100, services: ["Cardiac", "ER", "Neuro"], image: HOSP_IMGS[1] },
    { id: 3, name: "Khyber Teaching Hospital", area: "Jamrud Road", address: "Jamrud Rd, Peshawar", distance: "2.0 km", open: true, phone: "+92 91 921 1301", rating: 4.5, reviews: 2800, services: ["ER", "Surgery", "ICU"], image: HOSP_IMGS[2] },
    { id: 4, name: "Northwest General Hospital", area: "Phase 5, Hayatabad", address: "Phase 5 Hayatabad, Peshawar", distance: "2.6 km", open: true, phone: "+92 91 580 0400", rating: 4.6, reviews: 1600, services: ["Cardiac", "ER", "Pediatric"], image: HOSP_IMGS[3] },
    { id: 5, name: "Rehman Medical Institute", area: "Phase 5, Hayatabad", address: "Phase 5, Hayatabad, Peshawar", distance: "3.1 km", open: true, phone: "+92 91 580 0500", rating: 4.8, reviews: 2200, services: ["ICU", "ER", "Cardiac"], image: HOSP_IMGS[4] },
    { id: 6, name: "MTI Khyber Teaching Hospital", area: "University Road", address: "University Rd, Peshawar", distance: "4.0 km", open: false, phone: "+92 91 921 1302", rating: 4.3, reviews: 1100, services: ["ER", "Surgery"], image: HOSP_IMGS[5] },
  ],
};

const DOCTORS = [
  { id: 1, name: "Dr. Sarah Johnson", specialty: "Emergency Physician", experience: 12, rating: 4.9, reviews: 340, fee: 150, available: true, image: DOCTOR_IMGS[0], location: "Downtown Medical Center" },
  { id: 2, name: "Dr. Rajan Patel", specialty: "Cardiologist", experience: 15, rating: 4.8, reviews: 520, fee: 200, available: true, image: DOCTOR_IMGS[1], location: "City Heart Institute" },
  { id: 3, name: "Dr. Amanda Lin", specialty: "Trauma Specialist", experience: 10, rating: 4.7, reviews: 280, fee: 180, available: true, image: DOCTOR_IMGS[2], location: "Metro Trauma Center" },
  { id: 4, name: "Dr. Lin Wei", specialty: "Neurologist", experience: 18, rating: 4.9, reviews: 610, fee: 220, available: false, image: DOCTOR_IMGS[3], location: "Neuro Excellence Clinic" },
  { id: 5, name: "Dr. Marcus Brown", specialty: "Pulmonologist", experience: 13, rating: 4.6, reviews: 390, fee: 170, available: true, image: DOCTOR_IMGS[4], location: "Lung & Chest Specialists" },
  { id: 6, name: "Dr. Elena Vazquez", specialty: "Cardiologist", experience: 9, rating: 4.8, reviews: 270, fee: 190, available: true, image: DOCTOR_IMGS[5], location: "Heart & Vascular Institute" },
];
...
const DOCTOR_REPLIES = [
  ...
  "I recommend calling 115 immediately if symptoms are worsening. I'll coordinate with the ER.",
];
        ...
        <div className="p-8 flex flex-col items-center gap-6">
          <div className="relative">
            ...
            <img src={entity.image} alt={entity.name}
              onError={e => { (e.target as HTMLImageElement).src = DOCTOR_IMGS[0]; }}
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <motion.div initial={{ y: 80, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 80, opacity: 0 }}
        ...
        <div className="flex items-center gap-3 px-4 py-3.5 bg-gradient-to-r from-sky-700 to-cyan-600 shrink-0">
          <img src={entity.image} onError={e => { (e.target as HTMLImageElement).src = DOCTOR_IMGS[0]; }}
          ...
          {messages.map((msg, i) => (
            <div key={i} className={`flex ${msg.from === "user" ? "justify-end" : "justify-start"} gap-2`}>
              ...
              <div className={`max-w-[75%] ${msg.from === "user" ? "items-end" : "items-start"} flex flex-col gap-1`}>
                <div className={`px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${msg.from === "user" ? "bg-sky-600 text-white rounded-br-sm" : "bg-slate-700/80 border border-white/5 text-gray-100 rounded-bl-sm"}`}>{msg.text}</div>
          ...
          <>
            ...
            <form onSubmit={submit} className="p-5 space-y-4">
              {[
                ...
                { icon: Phone, label: "Phone Number", key: "phone", type: "tel", placeholder: "+92 300 1234567" },
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative h-40 overflow-hidden">
        <img src={h.image} alt={h.name} onError={e => { (e.target as HTMLImageElement).src = HOSP_IMGS[0]; }}
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative h-24 bg-gradient-to-br from-slate-800 to-slate-700 overflow-hidden">
        ...
        <img src={doc.image} alt={doc.name} onError={e => { (e.target as HTMLImageElement).src = DOCTOR_IMGS[0]; }}
...
export default function Emergency() {
  ...
  const doSearch = (q: string) => {
    ...
    setHospitals(result);
    setSearched(true);
    setTimeout(() => hospitalsRef.current?.scrollIntoView({ behavior: "smooth" }), 100);
  };
  ...
  const findNearby = () => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        () => {
          window.open("https://www.google.com/maps/search/hospital+emergency+near+me+pakistan", "_blank");
          setLocating(false);
          doSearch("default");
        }
      );
  ...
  const SERVICES = [
    { icon: Ambulance, label: "Ambulance Support", desc: "24/7 emergency ambulance dispatch across Pakistan", color: "text-red-400", bg: "from-red-500/10 to-rose-500/5 border-red-500/20" },
    { icon: ShieldAlert, label: "ER Hospital Access", desc: "Instant access to emergency rooms near you", color: "text-blue-400", bg: "from-blue-500/10 to-cyan-500/5 border-blue-500/20" },
    { icon: Activity, label: "Doctor Recommendation", desc: "AI-matched emergency specialists instantly", color: "text-emerald-400", bg: "from-emerald-500/10 to-teal-500/5 border-emerald-500/20" },
    { icon: Phone, label: "Emergency Hotline", desc: "Round-the-clock emergency contacts (115)", color: "text-amber-400", bg: "from-amber-500/10 to-orange-500/5 border-amber-500/20" },
  ];

  return (
    <div className="w-full bg-slate-950 min-h-screen pb-24 overflow-x-hidden">

      {/* ── CINEMATIC HERO WITH AMBULANCE BACKGROUND ── */}
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Ambulance background with slow zoom */}
        <motion.div
          initial={{ scale: 1.12 }}
          animate={{ scale: 1 }}
        ...
        >
          <img
            src="https://images.pexels.com/photos/263210/pexels-photo-263210.jpeg?auto=compress&cs=tinysrgb&w=1920"
          ...
          <div className="container mx-auto max-w-3xl">
            ...
            >
              ...
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
                ...
                Get immediate medical help, connect with emergency doctors, and find nearby hospitals across Pakistan instantly.
              </motion.p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                ...
                <button
                  onClick={findNearby}
                  disabled={locating}
                  className="relative group flex items-center gap-3 px-8 py-4 bg-red-600 hover:bg-red-500 text-white font-black text-base rounded-2xl shadow-2xl shadow-red-900/60 transition-all hover:scale-105 overflow-hidden disabled:opacity-70"
                ...
                >
                  ...
                  <span className="relative">{locating ? "Locating…" : "Find Nearby Hospitals"}</span>
                </button>
              ...
              <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 2, repeat: Infinity }}
                ...
                <span>scroll down to search</span>
        ...
        {contactModal && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }}
              ...
              <div className="h-1 bg-gradient-to-r from-red-500 to-rose-400" />
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                <h3 className="font-bold text-white flex items-center gap-2"><Phone className="w-4 h-4 text-red-400" /> Pakistan Emergency Contacts</h3>
              ...
              <div className="p-5 space-y-3">
                {[
                  { label: "Rescue (Police/Fire/Ambulance)", number: "1122", color: "bg-red-600 hover:bg-red-500" },
                  { label: "Edhi Ambulance Service", number: "115", color: "bg-orange-600 hover:bg-orange-500" },
                  { label: "Aman Foundation Ambulance", number: "1021", color: "bg-sky-600 hover:bg-sky-500" },
                  { label: "Chhipa Welfare Ambulance", number: "1020", color: "bg-emerald-600 hover:bg-emerald-500" },
                  { label: "Mental Health Crisis Line", number: "0311-7786264", color: "bg-purple-600 hover:bg-purple-500" },
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              If the patient is unconscious or having difficulty breathing, <span className="text-red-400 font-bold">contact emergency services immediately</span>. Do not delay — call <span className="text-white font-black">1122</span> (Rescue) or <span className="text-white font-black">115</span> (Edhi) right now.
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div ref={hospitalsRef} className="container mx-auto max-w-5xl px-4 mb-14">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          ...
          <h2 className="text-xl font-bold text-white mb-1 flex items-center gap-2">
            <MapPin className="w-5 h-5 text-red-400" /> Search Nearby Hospitals in Pakistan
          </h2>
          <p className="text-slate-500 text-sm mb-5">Try: Karachi, Lahore, Islamabad, Peshawar, Gulshan, DHA, North Nazimabad</p>
          ...
          <div className="flex gap-3 mb-6">
            <div className="relative flex-1">
              ...
              <input type="text" value={searchQuery} onChange={e => setSearchQuery(e.target.value)}
                ...
                placeholder="Enter city or area (e.g. Karachi, Lahore, DHA)…"
            ...
            <button onClick={() => doSearch(searchQuery)}
              className="px-6 py-3.5 bg-red-600 hover:bg-red-500 text-white font-bold rounded-2xl flex items-center gap-2 transition-colors shadow-lg shadow-red-900/40 whitespace-nowrap">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {["Karachi", "Lahore", "Islamabad", "Peshawar", "Gulshan", "DHA", "North Nazimabad"].map(c => (
